...
const Header = () => {
  ...
  return (
    ...
    <header className="fixed top-0 py-2.5 w-full z-10" style={{background:"#FFC107"}}>

      {/* <!-- navbar container --> */}
      <div className="w-full  sm:w-/12 px-1 sm:px-4 m-auto flex justify-between items-center relative flex">
      <div className='flex items-center justify-start mb-10 mr-20'>
  <Link className="h-7 mr-1 sm:mr-11" to="/">
    <img
      draggable="false"
      className="object-contain h-210 w-20"
      src={logo}
      alt="Smashdeals"
    />
  </Link>
        ...
        <div className="flex items-center flex-1">
          ...
          {/* <Link className="h-7 mr-1 sm:mr-5 " to="/">
            <img draggable="false" className="h-full w-full object-contain"  src={logo}  alt="Smashdeals"/>
          </Link> */}
