    ...
    const navs = [
        {
            ...
            redirect: "https://www.Smashdeals.com/communication-preferences/push",
        },
        {
            title: "Sell on Smashdeals",
            icon: <BusinessCenterIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://seller.Smashdeals.com/sell-online",
        },
        {
        ...
        },
        {
            ...
            redirect: "https://advertising.Smashdeals.com",
        },
        {
            title: "Download App",
            icon: <DownloadIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.Smashdeals.com/mobile-apps",
        },
    ]
